...
def market_price():
    currentPrice = btcData.getCurrentPrice()  # Assuming this function returns the current market price
...
def update_strategy():
    if request.method == 'POST':
        ...
        with open(path, 'r+') as file:
            ...
            json.dump(strategies, file, indent=4)  # Write updated strategies to file
            file.truncate()  # Truncate any remaining content beyond the updated data
...
def downloadScript():
    ...
    path = "C:/Users/tgtA/Desktop/Upstart/app/data/strategy.json"
    with open(path) as f:
...
def simulate():
    factor = random.randint(70000, 80000)
    #factor = btcData.getCurrentPrice()
